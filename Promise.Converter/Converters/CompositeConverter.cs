...
public class CompositeConverter : ValueConverterBase<object>
{
    ...
    /// </summary>
    public static readonly DependencyProperty ConvertersProperty = PropertyRegister.Register<CompositeConverter, ConverterCollection>(i => i.Converters, new ConverterCollection());
